      ...
      <div className='p-3 max-w-3xl mx-auto min-h-screen'>
          ...
          <form className='flex flex-col gap-4'>
              ...
              border-teal-500 border-dotted p-3'>
                  ...
                  <Button type='button' className="bg-gradient-to-br from-green-400 to-blue-600 text-white hover:bg-gradient-to-bl focus:ring-green-200 dark:focus:ring-green-800" outline>
                      Upload Image
                  </Button>
              </div>
